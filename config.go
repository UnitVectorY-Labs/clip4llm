...
// loadConfig is the legacy function for backward compatibility
// It returns a map[string]string for use with the current main.go implementation
...
// loadConfigFromFile is the legacy function for backward compatibility
